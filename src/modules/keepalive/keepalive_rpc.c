...
static const char *keepalive_rpc_add_doc[2] = {
		"adds new destination to keepalive memory. usage keepalive.add sip:xx@domain listname", 0};
...
static const char *keepalive_rpc_del_doc[2] = {
		"deletes destination from keepalive memory. usage keepalive.del sip:xx@domain listname", 0};
